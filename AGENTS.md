dont use --upload when flashing app firmware, use swd/openocd to reset and flash it.
...
- SPI0 and SPI1 buses for IMU, barometer, and compass sensors
 ...
 see:
 libraries/AP_HAL_ChibiOS/hwdef/Laurel/README.md
 libraries/AP_HAL_ChibiOS/hwdef/Laurel/FEATURE_GAP.md

 libraries/AP_HAL_ChibiOS/hwdef/Pico2/README.md
 libraries/AP_HAL_ChibiOS/hwdef/Pico2/FEATURE_GAP.md
