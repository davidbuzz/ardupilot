...
- `platforms/rp2350_base.repl`, `platforms/rp2350_rpi_uavfc.repl` and
  `scripts/ardupilot_rp2350.resc` — dual-core RP2350 (RPI_UAVFC) platform: both
  Cortex-M33 cores in serial execution, SIO core launch/spinlocks/doorbells,
  DMA, PL022 SPI, PL011 UART, DesignWare I2C, 64-bit timers and QMI
  direct-mode flash storage under `peripherals/rp2350/`. Not generated by
  `run.py`: the board file and the .resc wire the IMU, baro, compass, GPS,
  microSD and the PWM actuator tap by hand.
