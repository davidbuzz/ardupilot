...
static void gpio_init(GPIO_Type *gpiop, const gpio_setup_t *config) {
...
//#warning todo buzz gpio init code
#else
  rccResetAHB1(STM32_GPIO_EN_MASK);
  rccEnableAHB1(STM32_GPIO_EN_MASK, true);
#endif

// buz todo nxp call them GPIO1 to GPIO9  of GPIO_Type

  /* Initializing all the defined GPIO ports.*/
// #if STM32_HAS_GPIOA
   gpio_init(GPIO1, &gpio_default_config.PAData);
// #endif
// #if STM32_HAS_GPIOB
   gpio_init(GPIO2, &gpio_default_config.PBData);
// #endif
// #if STM32_HAS_GPIOC
