...
| CPU / Performance | Scheduler loop rate tuning | 400 Hz on STM32 | 200 Hz on Laurel | ✅ | ✅ done | `SCHED_LOOP_RATE 200` in defaults.parm. Debug-build fast-task total is ~6100 us/loop (read_AHRS 4220 us + update_flight_mode 1521 us dominate). At 200 Hz (5000 us budget) this is 122% — still overloaded in debug mode, but OVR counts dropped drastically (read_AHRS OVR: 999→18, update_flight_mode: 176→0). Release builds with -O2 should drop EKF to ~500 us making 400 Hz viable. |
