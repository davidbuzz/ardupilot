...
| Filesystem / Logging | MAVFTP `get @SYS/threads.txt` | Works on mainstream targets | Must work on Laurel | ✅ | ✅ done | Fixed 2026-04-09 by the priority-fix commit. `OpenFileRO @SYS/threads.txt` returns ACK with file size 100000 bytes over USB CDC. Full ReadFile sequence also functional. |
