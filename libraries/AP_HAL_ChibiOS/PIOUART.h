...
// Instruction memory layout (10 of 32 words used per PIO):
//   [0..4]  TX program
//   [5..9]  RX program
...
//   0x8020: push  noblock
//
// Note: bring-up keeps RX permissive here (no explicit stop-bit gate) so
// small sample-phase errors do not suppress all bytes on loopback tests.
