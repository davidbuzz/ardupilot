...
#define PIO_UART_TX_PROG_LEN     4U
#define PIO_UART_RX_PROG_OFFSET  4U
...
static const uint16_t k_pio_uart_tx_pgm[PIO_UART_TX_PROG_LEN] = {
    0x9FA0u, 0xF727u, 0x6001u, 0x0642u,
};

// RX: 8 cycles/bit, pre-relocated for offset 4
//   0x2020: wait  0 pin, 0
//   0xEA27: set   x, 7             [10]
//   0x4001: in    pins, 1
//   0x0646: jmp   x--, 6           [6]   (target=6 = offset+2)
//   0x00CB: jmp   pin, 11                (target=11 = offset+7)
//   0xC014: irq   4 rel
//   0x20A0: wait  1 pin, 0
//   0x8020: push  noblock
static const uint16_t k_pio_uart_rx_pgm[PIO_UART_RX_PROG_LEN] = {
    0x2020u, 0xEA27u, 0x4001u, 0x0646u,
    0x00CBu, 0xC014u, 0x20A0u, 0x8020u,
};
...
#define PIO_PINCTRL_SET_COUNT_LSB    25u
