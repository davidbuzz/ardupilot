...
#if defined(RP2350)
// Stub STM32 DMA types/functions for RP2350 builds. The pwm_group struct and
// dma_cancel() use stm32_dma_stream_t*, but group.dma is always nullptr on
// RP2350 (DShot/DMA not enabled) so none of these functions are ever called.
