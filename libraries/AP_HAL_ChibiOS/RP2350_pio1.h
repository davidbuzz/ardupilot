...
// OSD_TYPE and OSD_TYPE2 value selecting the PIO scan-out; AP_OSD pins its
// enum to this, as the HAL cannot include AP_OSD.h.
static constexpr uint8_t PIO1_OSD_TYPE = 6;
