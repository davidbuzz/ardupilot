...
// #endif
// the above define is now part of chtypes.h as NOINLINE is used in the ChibiOS port and we want to be able to use it in AP_Common without including chtypes.h
