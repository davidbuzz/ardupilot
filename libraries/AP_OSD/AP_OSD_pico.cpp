...
/*
  ...
  without the HAL depending on AP_OSD, so the value is defined there and
  pinned here.
 */
static_assert((int)AP_OSD::osd_types::OSD_PICO == ChibiOS::PIO1_OSD_TYPE,
              "OSD_PICO must match PIO1_OSD_TYPE in RP2350_pio1.h");
