...
#endif
#undef HAL_HAVE_RTSCTS_SERIAL1
#undef HAL_HAVE_RTSCTS_SERIAL2
#undef HAL_HAVE_RTSCTS_SERIAL3
#undef HAL_HAVE_RTSCTS_SERIAL4
#undef HAL_HAVE_RTSCTS_SERIAL5
#undef HAL_HAVE_SAFETY_SWITCH
#undef HAL_HAVE_IMU_HEATER
#undef AP_FEATURE_BOARD_DETECT
#undef HAL_WITH_IO_MCU
#undef HAL_RCINPUT_WITH_AP_RADIO
#undef HAL_PIN_ALT_CONFIG
#endif
