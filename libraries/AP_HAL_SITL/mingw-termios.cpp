//from https://github.com/chjchoi/kai/tree/master/project/linux-cortexm-1.9.0/A2F/gdb-2011.03/cs-cygwin-wrapper
// and renamed from .c to .cpp
...
int
tcgetattr (int fd, struct termios2 *buf)
{
  int ret;
  char *retdata;
...
int
tcsetattr (int fd, int actions, const struct termios2 *buf)
{
  int ret;
  char *retdata;
